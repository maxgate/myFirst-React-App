...
const UpdateCard = ({
  ...
  return (
    <div className=" flex justify-start items-start flex-rows px-4 py-4 rounded-[8px]  max-w-[400px] sm:w-full xs:w-full  md:mr-6 sm:mr-10 mr-0 my-5 border border-gray-200 bg-primary hover:bg-gray-50
      ">
      <div className="">
        <img
          src={img}
      ...
      <div className="px-6 text-gray-600 py-2">
        ...
        <span className="flex text-[12px] ">
          ...
          <p className="px-6 ">By <span className="hover:underline">{author}</span> </p>
        </span>
        <span className="flex text-[12px] ">
          <p className="">
