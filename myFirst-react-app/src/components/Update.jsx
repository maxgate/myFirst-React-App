...
const Update = () => (
  <section>
    <div>
      <h2
        className={`text-[26px] font-semibold ${styles.paddingX} pt-20 font-poppins`}
      >
        What's happening on Postman
      </h2>
      <h4 className={`${styles.paddingX} font-semibold text-gray-700`}>
      ...
      <div className={`pl-6 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 sm:w-full xs:grid-cols-1 xs:w-full pb-16 `}>
        {updateCard.map((card) => (
